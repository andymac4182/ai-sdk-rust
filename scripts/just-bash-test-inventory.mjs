...
const r12jbR4SearchEngineCaseGroups = [
  ...
  },
  {
    ...
    lines: [
      16, 23, 29, 35, 41, 47, 55, 63, 70, 77, 84, 91, 98, 104, 113, 117, 121,
      125, 131, 135, 140, 144, 148, 152, 159, 163, 169, 177, 183, 187, 193, 197,
      201, 205, 209, 217, 226, 230, 236, 243,
    ],
    status: 'portable-verified',
    owner: 'crates/just-bash::search_engine',
    rustTest:
      'search_engine_regex_prefilter_bare_literal_basic; search_engine_regex_prefilter_strips_w_wrapper_single_literal; search_engine_regex_prefilter_strips_w_wrapper_around_alternation; search_engine_regex_prefilter_splits_top_level_alternation_extended; search_engine_regex_prefilter_lowercases_needles_when_ignore_case; search_engine_regex_prefilter_fixed_strings_are_literal_needles; search_engine_regex_prefilter_decodes_meta_escaped_by_fixed; search_engine_regex_prefilter_decodes_n_t_r_escapes; search_engine_regex_prefilter_leading_anchored_literal; search_engine_regex_prefilter_trailing_anchored_literal; search_engine_regex_prefilter_fully_anchored_literal; search_engine_regex_prefilter_anchored_alternation_issue_case; search_engine_regex_prefilter_mixed_anchored_unanchored_alternation; search_engine_regex_prefilter_preserves_escaped_dollar; search_engine_regex_prefilter_rejects_quantifier_plus; search_engine_regex_prefilter_rejects_quantifier_star; search_engine_regex_prefilter_rejects_quantifier_question; search_engine_regex_prefilter_rejects_quantifier_braces; search_engine_regex_prefilter_rejects_character_class; search_engine_regex_prefilter_rejects_dot_basic; search_engine_regex_prefilter_rejects_digit_class; search_engine_regex_prefilter_rejects_word_class; search_engine_regex_prefilter_rejects_whitespace_class; search_engine_regex_prefilter_rejects_bare_word_boundary; search_engine_regex_prefilter_rejects_capturing_group; search_engine_regex_prefilter_rejects_non_capturing_group_without_frame; search_engine_regex_prefilter_rejects_alternation_branch_with_meta; search_engine_regex_prefilter_rejects_nested_alternation_in_group; search_engine_regex_prefilter_rejects_hex_escape; search_engine_regex_prefilter_rejects_unicode_escape; search_engine_regex_prefilter_rejects_bare_caret; search_engine_regex_prefilter_rejects_bare_dollar; search_engine_regex_prefilter_rejects_caret_dollar_pair; search_engine_regex_prefilter_rejects_one_branch_without_needle; search_engine_regex_prefilter_rejects_mid_alternative_caret; search_engine_regex_prefilter_does_not_split_in_non_capturing_group; search_engine_regex_prefilter_does_not_split_in_character_class; search_engine_regex_prefilter_preserves_alternation_ordering; search_engine_regex_prefilter_does_not_over_strip_leading_word_boundary; search_engine_regex_prefilter_undefined_for_empty_pattern',
    notes:
      'r12jb-r4 ports buildRegex pre-filter extraction (crates/just-bash/src/search_engine.rs): bare/-w-wrapped/alternation/anchored literal needle extraction with -i lowercasing, -F fixed-string decoding (including regex-meta and \\n/\\t/\\r escapes), the canonical anchored-alternation issue case, escaped-$ preservation, and the quantifier (+/*/?) safety rejections. r14jb-r2 closes the remaining safety rows (`{n,m}`, character class, BRE `.`, `\\d`/`\\w`/`\\s`, bare `\\b`, capturing/non-capturing groups, meta-bearing alternation branches, nested alternation, `\\x`/`\\u` escapes, bare/paired/mid-alternative anchors, branch-without-needle) and the structural-correctness rows (no `|` split inside non-capturing groups or character classes, preserved alternation ordering, no over-strip of a leading `\\b`, and empty-pattern undefined).',
  },
];

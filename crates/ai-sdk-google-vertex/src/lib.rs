//! Package-owned inventory checkpoint for upstream `@ai-sdk/google-vertex`.
//!
...
mod tests {
    ...
    fn google_vertex_foundational_inventory_tracks_current_upstream_cases() {
        ...
        assert_eq!(PORTABLE_UNMAPPED_CASES, 201);
        assert_eq!(
            INVENTORY_DOCUMENT,
    ...
    #[test]
    fn google_vertex_foundational_inventory_has_no_ported_cases_yet() {
        assert_eq!(PORTABLE_UNMAPPED_CASES + JS_ONLY_DOCUMENTED_CASES, 204);
    }
}

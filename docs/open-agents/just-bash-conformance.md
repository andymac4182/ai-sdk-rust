...
The current parity ledger maps 4,088 upstream rows to named Rust tests, NAPI-backed JS proofs, or generated corpus proofs, leaves
5,452 rows `portable-pending`, documents 396 JS-only exceptions, and has 5,463 strict gate gaps. The remaining closure wave is tracked as JBC-19 through

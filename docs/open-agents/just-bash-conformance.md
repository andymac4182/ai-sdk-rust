...
The current parity ledger maps 4,363 upstream rows to named Rust tests, NAPI-backed JS proofs, or generated
corpus proofs, leaves 4,732 rows `portable-pending`, documents 841 JS-only exceptions, and has 4,743 strict gate gaps. The conformance corpus now maps 400 generated cases to Rust runner proofs and leaves 1,271 generated cases pending.

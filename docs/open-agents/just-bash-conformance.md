...
The current parity ledger maps 5,913 upstream rows to named Rust tests, NAPI-backed JS proofs, or generated
corpus proofs, leaves 2,935 rows `portable-pending`, documents 1,088 JS-only exceptions, and has 2,935 strict gate gaps. The conformance corpus now maps 544 generated cases to Rust runner proofs and leaves 1,127 generated cases pending.
...
| Status | Cases |
| --- | --- |
| portable-pending | 1127 |
| portable-verified | 544 |

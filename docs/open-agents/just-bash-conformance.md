...
The current parity ledger maps 4,551 upstream rows to named Rust tests, NAPI-backed JS proofs, or generated
corpus proofs, leaves 4,791 rows `portable-pending`, documents 594 JS-only exceptions, and has 4,802 strict gate gaps. The conformance corpus now maps 400 generated cases to Rust runner proofs and leaves 1,271 generated cases pending.

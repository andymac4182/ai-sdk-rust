...
The current parity ledger maps 2,690 upstream rows to named Rust tests, NAPI-backed JS proofs, or generated corpus proofs, leaves
7,087 rows `portable-pending`, documents 159 JS-only exceptions, and has 7,098 strict gate gaps. The remaining closure wave is tracked as JBC-19 through
...
| Status | Cases |
| --- | --- |
| portable-pending | 1322 |
| portable-verified | 349 |

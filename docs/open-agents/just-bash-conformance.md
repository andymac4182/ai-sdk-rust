...
The current parity ledger maps 4,399 upstream rows to named Rust tests, NAPI-backed JS proofs, or generated
corpus proofs, leaves 4,966 rows `portable-pending`, documents 571 JS-only exceptions, and has 4,977 strict gate gaps. The conformance corpus now maps 403 generated cases to Rust runner proofs and leaves 1,268 generated cases pending.

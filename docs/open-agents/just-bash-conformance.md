...
The current parity ledger maps 4,342 upstream rows to named Rust tests, NAPI-backed JS proofs, or generated
corpus proofs, leaves 5,029 rows `portable-pending`, documents 565 JS-only exceptions, and has 5,040 strict gate gaps. The conformance corpus now maps 400 generated cases to Rust runner proofs and leaves 1,271 generated cases pending. The remaining closure wave is tracked as JBC-31

...
The current parity ledger maps 4,488 upstream rows to named Rust tests, NAPI-backed JS proofs, or generated
corpus proofs, leaves 4,873 rows `portable-pending`, documents 575 JS-only exceptions, and has 4,884 strict gate gaps. The conformance corpus now maps 400 generated cases to Rust runner proofs and leaves 1,271 generated cases pending.

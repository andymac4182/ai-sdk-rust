...
The current parity ledger maps 4,958 upstream rows to named Rust tests, NAPI-backed JS proofs, or generated
corpus proofs, leaves 4,407 rows `portable-pending`, documents 571 JS-only exceptions, and has 4,418 strict gate gaps. The conformance corpus now maps 400 generated cases to Rust runner proofs and leaves 1,271 generated cases pending.

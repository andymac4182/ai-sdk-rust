...
The current parity ledger maps 1,879 upstream rows to named Rust tests or generated corpus proofs, leaves
7,933 rows `portable-pending`, documents 124 JS-only exceptions, and has 7,933 strict gate gaps. The next closure wave is tracked as JBC-17 through JBC-32 in

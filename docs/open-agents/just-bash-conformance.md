...
The current parity ledger maps 2,857 upstream rows to named Rust tests, NAPI-backed JS proofs, or generated corpus proofs, leaves
6,920 rows `portable-pending`, documents 159 JS-only exceptions, and has 6,931 strict gate gaps. The remaining closure wave is tracked as JBC-19 through

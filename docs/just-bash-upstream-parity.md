...
filesystem/path case rows plus three source rows, and JBC-27 maps 713 additional
...
exceptions. After regeneration the combined Just Bash ledger is `4,088` verified
/ `5,452` pending / `396` JS-only, with `5,463` strict gate gaps. These slices
...
JBC-10, JBC-11, JBC-13, JBC-16, JBC-22, JBC-23, JBC-24, and JBC-25
...
JBC-26 filesystem/path closure is tracked in the filesystem table below.

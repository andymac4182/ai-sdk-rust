...
additional JS-only runtime bridge exceptions, and JBC-39 closes 2 optional
language boundary rows while documenting 270 additional host-runtime/package
runtime exceptions. After regeneration the combined Just Bash ledger is `4,363`
verified / `4,732` pending / `841` JS-only, with `4,743` strict gate gaps. These slices

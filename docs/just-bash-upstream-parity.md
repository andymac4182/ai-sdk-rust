...
runtime exceptions, and JBC-43 closes 25 exact grep rows. After regeneration
the combined Just Bash ledger is `5,583` verified / `3,272` pending / `1,081`
JS-only, with `3,272` strict gate gaps. These slices

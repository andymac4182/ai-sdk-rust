...
additional JS-only runtime bridge exceptions. After regeneration the combined
Just Bash ledger is `4,094` verified / `5,318` pending / `524` JS-only, with
`5,329` strict gate gaps. These slices

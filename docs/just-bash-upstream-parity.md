...
JBC-24 closes 167 additional exact structured-data/query-engine rows, and
JBC-25 closes 113 additional exact AWK rows. After regeneration the combined
Just Bash ledger is `2,970` verified / `6,807` pending / `159` JS-only, with
`6,818` strict gate gaps. These slices do not

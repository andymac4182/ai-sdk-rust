...
remaining query-engine safe-object helper rows, and JBC-45 closes 155 exact
core/filesystem/comparison rows without hiding command-family mismatches. After
regeneration the combined Just Bash ledger is `5,823` verified / `3,025`
pending / `1,088` JS-only, with `3,025` strict gate gaps. These slices

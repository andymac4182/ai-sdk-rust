...
- 2026-05-24: `packages/ai` `customProvider` direct model-map parity added
  ...
  Optional model families, fallback files/skills, and string aliases remain
  tracked as open `customProvider` registry-family parity.

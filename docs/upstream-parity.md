...
- 2026-05-24: `packages/ai` `ToolLoopAgent` telemetry integration parity
  added named Rust counterparts for upstream generate and stream per-call
  integration listener lifecycle ordering through a local tool loop. The tests
  are

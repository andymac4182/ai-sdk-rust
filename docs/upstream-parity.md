...
- 2026-05-24: `packages/ai` `customProvider` direct model-map parity added
  ...
  Optional model fallback providers, fallback files/skills, and string aliases
  remain tracked as open `customProvider` registry-family parity.

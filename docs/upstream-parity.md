...
7. Continue `packages/ai` utility/core parity from the upstream corpus.
   ...
   async-iterable/stitching/download/runtime-specific helpers, documenting
   JavaScript-only stream/server-response cases where Rust has no equivalent
   runtime boundary.

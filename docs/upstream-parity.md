...
3. Expand Gateway beyond the current language, streaming,
   image/embedding/reranking/video, account metadata, and error-classification
   slices with broader provider package tests.

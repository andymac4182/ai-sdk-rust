...
- 2026-05-25: `packages/ai` UI-message dynamic data chunk wire parity added
  ...
  `type: "data-*"` wire chunks deserialize into Rust's typed `Data` variant
  and process into upstream-shaped `data-*` UI parts with id replacement.

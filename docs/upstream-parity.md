...
- 2026-05-25: `packages/ai` `streamText` `onStepStart` telemetry metadata
  suppression parity added `stream_text_on_step_start_omits_telemetry_metadata`,
  proving the serialized step-start callback event does not leak `functionId`

...
- `packages/chat` in-progress at 74%: 11 modules portable-mapped (errors 17, logger 13, chat_singleton 5, emoji 42/42, modals 25, markdown 122/122 (1:1 COMPLETE), cards 29/28 incl fallback, callback_url 5/17, message 10/19, plan 10 additive, transcripts 9 additive, postable_object 4 additive, reviver 6 additive). 284 colocated Rust tests. Sub-file js-only-adjacent: `jsx-*` runtime files, `mock-adapter.ts`, `message-history.ts`.

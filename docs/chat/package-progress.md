...
- Average estimated completion: 3.1%
- Portable package average: 3.1%
...
| --- | ---: | --- | --- | --- |
| `@chat-sdk/chat` | 30% | In progress | core SDK package | Crate + idiomatic colocated tests for errors (17) + logger (13) + chat_singleton (5). Eleven types layers +... |

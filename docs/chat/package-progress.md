...
- Average estimated completion: 32.4%
- Portable package average: 18.9%
...
| --- | ---: | --- | --- | --- |
| `@chat-sdk/chat` | 84% | In progress | core SDK package | Crate + colocated tests across 13 modules: errors 17 + logger 13 + chat_singleton 5 + emoji 42/42 (1:1) + markdown... |

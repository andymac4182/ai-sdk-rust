...
- Average estimated completion: 2.9%
- Portable package average: 2.9%
...
| --- | ---: | --- | --- | --- |
| `@chat-sdk/chat` | 27% | In progress | core SDK package | Crate + idiomatic colocated tests for errors (17) + logger (13) + chat_singleton (5). Nine types layers + placeholder... |

...
- Average estimated completion: 58.1%
- Portable package average: 49.7%
...
| `@chat-sdk/adapter-slack` | 64% | In progress | adapter package | Slice 139 scaffold + slice 152 post_message + slice 158 fetch_subject (additive) + slice 160 edit/delete/react/typing... |

...
- Average estimated completion: 53.6%
- Portable package average: 44.3%
...
| `@chat-sdk/adapter-slack` | 47% | In progress | adapter package | Slice 139 scaffold + slice 152 post_message + slice 158 fetch_subject (additive) + slice 160 edit/delete/react/typing... |
...
| `@chat-sdk/adapter-telegram` | 44% | In progress | adapter package | Slice 130 scaffold + slice 145 post_message + slice 155 fetch_subject + slice 161 edit/delete/react/typing + slice 178... |

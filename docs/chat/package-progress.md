...
- Average estimated completion: 65.4%
- Portable package average: 58.5%
...
| `@chat-sdk/adapter-messenger` | 56% | In progress | adapter package | Slice 132 scaffold + slice 147 post_message + slice 163 edit/delete/react/typing + slice 173 wire-format correction +... |

...
- Average estimated completion: 53.7%
- Portable package average: 44.5%
...
| `@chat-sdk/adapter-slack` | 49% | In progress | adapter package | Slice 139 scaffold + slice 152 post_message + slice 158 fetch_subject (additive) + slice 160 edit/delete/react/typing... |

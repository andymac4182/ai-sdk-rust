...
- Average estimated completion: 63.4%
...
| `@chat-sdk/adapter-discord` | 55% | In progress | adapter package | Slice 134 scaffold + slice 149 post_message + slice 165 edit/delete/react/typing + slice 197 webhook Ed25519 + slice... |

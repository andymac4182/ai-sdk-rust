...
- Average estimated completion: 56.4%
- Portable package average: 47.7%
...
| `@chat-sdk/adapter-slack` | 53% | In progress | adapter package | Slice 139 scaffold + slice 152 post_message + slice 158 fetch_subject (additive) + slice 160 edit/delete/react/typing... |

...
- Average estimated completion: 6.3%
- Portable package average: 6.3%
...
| --- | ---: | --- | --- | --- |
| `@chat-sdk/chat` | 58% | In progress | core SDK package | Crate + colocated 1:1 tests for errors (17) + logger (13) + chat_singleton (5). Module subsets: markdown 33/122, cards... |
| `@chat-sdk/adapter-shared` | 55% | In progress | shared adapter utilities | Crate + colocated 1:1 tests for errors (24) + card_utils (7 of 39) + buffer_utils (7 of 16 -... |

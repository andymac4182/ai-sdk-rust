...
- Average estimated completion: 62.7%
...
| `@chat-sdk/adapter-teams` | 48% | In progress | adapter package | Slice 138 scaffold + slice 153 post_message + slice 167 edit/delete/react/typing + slice 172 errors + slice 217... |

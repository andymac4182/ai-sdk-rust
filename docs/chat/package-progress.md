...
- Average estimated completion: 57.9%
- Portable package average: 49.5%
...
| `@chat-sdk/adapter-slack` | 62% | In progress | adapter package | Slice 139 scaffold + slice 152 post_message + slice 158 fetch_subject (additive) + slice 160 edit/delete/react/typing... |

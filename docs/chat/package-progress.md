...
- Average estimated completion: 57.8%
- Portable package average: 49.4%
...
| `@chat-sdk/adapter-slack` | 60% | In progress | adapter package | Slice 139 scaffold + slice 152 post_message + slice 158 fetch_subject (additive) + slice 160 edit/delete/react/typing... |

...
- Average estimated completion: 2.8%
- Portable package average: 2.8%
...
| --- | ---: | --- | --- | --- |
| `@chat-sdk/chat` | 25% | In progress | core SDK package | Crate + idiomatic colocated tests for errors (17) + logger (13) + chat_singleton (5). Eight types layers + placeholder... |

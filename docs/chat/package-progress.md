...
- Average estimated completion: 2.7%
- Portable package average: 2.7%
...
| --- | ---: | --- | --- | --- |
| `@chat-sdk/chat` | 24% | In progress | core SDK package | Crate + idiomatic colocated tests for errors (17) + logger (13) + chat_singleton (5). Seven types layers + placeholder... |

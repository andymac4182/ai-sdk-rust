...
- Average estimated completion: 55.9%
- Portable package average: 47.1%
...
| `@chat-sdk/adapter-messenger` | 44% | In progress | adapter package | Slice 132 scaffold + slice 147 post_message + slice 163 edit/delete/react/typing + slice 173 wire-format correction +... |
...
| `@chat-sdk/adapter-whatsapp` | 41% | In progress | adapter package | Slice 133 scaffold + slice 148 post_message + slice 164 edit/delete/react/typing + slice 179 cards + slice 189... |

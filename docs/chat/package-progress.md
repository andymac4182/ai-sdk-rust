...
- Average estimated completion: 5.4%
- Portable package average: 5.4%
...
| `@chat-sdk/adapter-shared` | 40% | In progress | shared adapter utilities | Crate + colocated 1:1 tests for errors (24) + card_utils (7 of 39 -... |

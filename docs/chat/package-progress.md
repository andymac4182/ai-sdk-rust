...
- Average estimated completion: 33.2%
- Portable package average: 19.8%
...
| --- | ---: | --- | --- | --- |
| `@chat-sdk/chat` | 97% | In progress | core SDK package | Crate + colocated tests across 13 modules: errors 17 + logger 13 + chat_singleton 5 + emoji 42/42 (1:1) + markdown... |

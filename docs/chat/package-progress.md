...
| --- | ---: | --- | --- | --- |
| `@chat-sdk/chat` | 99% | In progress | core SDK package | Crate + colocated tests across 16 modules: 625 chat tests. Phase 1.5 complete. Slice 278 closes callback-url with... |

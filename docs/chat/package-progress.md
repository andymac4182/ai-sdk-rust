...
- Average estimated completion: 54.3%
- Portable package average: 45.1%
...
| --- | ---: | --- | --- | --- |
| `@chat-sdk/chat` | 99% | In progress | core SDK package | Crate + colocated tests across 16 modules: 581 chat tests. Phase 1.5 complete. Slice 159 extended Adapter trait with... |
| `@chat-sdk/adapter-slack` | 51% | In progress | adapter package | Slice 139 scaffold + slice 152 post_message + slice 158 fetch_subject (additive) + slice 160 edit/delete/react/typing... |

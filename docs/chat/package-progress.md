...
- Average estimated completion: 4.2%
- Portable package average: 4.2%
...
| --- | ---: | --- | --- | --- |
| `@chat-sdk/chat` | 50% | In progress | core SDK package | Crate + colocated 1:1 tests for errors (17) + logger (13) + chat_singleton (5). markdown subset (33 of 122) and cards... |

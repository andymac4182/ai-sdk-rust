...
- Average estimated completion: 4.4%
- Portable package average: 4.4%
...
| --- | ---: | --- | --- | --- |
| `@chat-sdk/chat` | 54% | In progress | core SDK package | Crate + colocated 1:1 tests for errors (17) + logger (13) + chat_singleton (5). Module subsets: markdown 33/122, cards... |

...
- Average estimated completion: 2.6%
- Portable package average: 2.6%
...
| --- | ---: | --- | --- | --- |
| `@chat-sdk/chat` | 22% | In progress | core SDK package | Crate + idiomatic colocated tests for errors (17) + logger (13) + chat_singleton (5). Six types layers + placeholder... |

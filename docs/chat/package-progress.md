...
- Average estimated completion: 61.6%
- Portable package average: 53.9%
...
| `@chat-sdk/adapter-gchat` | 58% | In progress | adapter package | Slice 137 scaffold + slice 154 post_message + slice 168 edit/delete/react/typing + slice 190 markdown converter +... |

...
- Average estimated completion: 53.2%
- Portable package average: 43.8%
...
| `@chat-sdk/adapter-slack` | 45% | In progress | adapter package | Slice 139 scaffold + slice 152 post_message + slice 158 fetch_subject (additive) + slice 160 edit/delete/react/typing... |
...
| `@chat-sdk/adapter-linear` | 38% | In progress | adapter package | Slice 136 scaffold + slice 151 post_message + slice 166 edit/delete/react/typing + slice 171 utils + slice 177 cards... |
| `@chat-sdk/adapter-github` | 40% | In progress | adapter package | Slice 131 scaffold + slice 146 post_message + slice 156 fetch_subject (additive) + slice 162 edit/delete/react/typing... |
| `@chat-sdk/adapter-messenger` | 38% | In progress | adapter package | Slice 132 scaffold + slice 147 post_message + slice 163 edit/delete/react/typing + slice 173 wire-format correction +... |
| `@chat-sdk/adapter-telegram` | 38% | In progress | adapter package | Slice 130 scaffold + slice 145 post_message + slice 155 fetch_subject + slice 161 edit/delete/react/typing + slice 178... |
| `@chat-sdk/adapter-whatsapp` | 34% | In progress | adapter package | Slice 133 scaffold + slice 148 post_message + slice 164 edit/delete/react/typing + slice 179 cards module... |

...
- Average estimated completion: 86.4%
- Portable package average: 83.7%
...
| `@chat-sdk/adapter-telegram` | 78% | In progress | adapter package | chat-sdk-adapter-telegram 142 tests (slice 504 ports message length limits +9). Helpers: applyTelegramEntities 11/11,... |

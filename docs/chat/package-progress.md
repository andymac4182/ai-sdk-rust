...
- Average estimated completion: 86.7%
- Portable package average: 84.0%
...
| `@chat-sdk/adapter-telegram` | 82% | In progress | adapter package | chat-sdk-adapter-telegram 151 tests (slices 504+505 port message length limits +9 + extractPlainText +9). Helpers:... |

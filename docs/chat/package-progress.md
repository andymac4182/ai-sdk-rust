...
- Average estimated completion: 60.5%
- Portable package average: 52.6%
...
| `@chat-sdk/adapter-telegram` | 58% | In progress | adapter package | Slice 130 scaffold + slice 145 post_message + slice 155 fetch_subject + slice 161 edit/delete/react/typing + slice 178... |

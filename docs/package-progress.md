...
| `@ai-sdk/openai` | 83% | In progress | provider package | OpenAI/Open Responses foundations, provider base URL precedence, Embeddings request/result parity, Completion... |

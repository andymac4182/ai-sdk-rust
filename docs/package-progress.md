...
- Average estimated completion: 50.7%
...
| `@ai-sdk/openai` | 80% | In progress | provider package | OpenAI/Open Responses foundations, provider base URL precedence, Embeddings request/result parity, non-Responses... |

...
- Average estimated completion: 50.6%
...
| `@ai-sdk/openai` | 79% | In progress | provider package | OpenAI/Open Responses foundations, provider base URL precedence, non-Responses OpenAI error schema parsing, Files... |

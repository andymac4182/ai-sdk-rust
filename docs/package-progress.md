...
| `@ai-sdk/openai` | 68% | In progress | provider package | OpenAI/Open Responses foundations, non-Responses OpenAI error schema parsing, and Files upload request/result parity... |

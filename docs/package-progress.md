...
| `@ai-sdk/openai` | 66% | In progress | provider package | OpenAI/Open Responses foundations and non-Responses OpenAI error schema parsing exist; broader files, skills, speech,... |

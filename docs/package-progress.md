...
- Average estimated completion: 50.0%
...
| --- | ---: | --- | --- | --- |
| `ai` | 78% | In progress | core package | Core surface is broad; remaining stream/UI/agent edge cases and root/package boundary cleanup. |

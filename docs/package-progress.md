...
| `@ai-sdk/openai` | 82% | In progress | provider package | OpenAI/Open Responses foundations, provider base URL precedence, Embeddings request/result parity, Completion... |

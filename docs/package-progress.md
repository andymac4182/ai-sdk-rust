...
| --- | ---: | --- | --- | --- |
| `ai` | 84% | In progress | core package | Core surface is broad; remaining stream/UI/agent edge cases and root/package boundary cleanup. |

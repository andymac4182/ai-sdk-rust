...
| `@ai-sdk/openai` | 74% | In progress | provider package | OpenAI/Open Responses foundations, non-Responses OpenAI error schema parsing, Files upload, Skills upload, Speech, and... |

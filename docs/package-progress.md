...
| `@ai-sdk/openai` | 78% | In progress | provider package | OpenAI/Open Responses foundations, non-Responses OpenAI error schema parsing, Files upload, Skills upload, Speech,... |

...
- Strict inventory full portable cases mapped: 7589 / 7619
- Strict inventory full portable cases unmapped: 30
- Displayed-row strict portable test cases mapped: 7207 / 7217
- Displayed-row strict portable test cases unmapped: 10
...
| --- | ---: | --- | --- | --- |
| `ai` | 99% | In progress | root core SDK package | strict test inventory: 10 portable upstream cases still need named Rust tests; sample failing IDs: `packages-ai-0905`;... |

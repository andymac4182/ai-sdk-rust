...
- Average estimated completion: 51.8%
- Portable package average: 41.0%
...
| `@ai-sdk/workflow` | 87% | In progress | agent/workflow package | WorkflowAgent and iterator callback/continuation coverage is substantial, including named providerMetadata/OpenAI... |

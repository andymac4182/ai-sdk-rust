...
- Strict inventory full portable cases mapped: 7592 / 7618
- Strict inventory full portable cases unmapped: 26
- Displayed-row strict portable test cases mapped: 7210 / 7216
- Displayed-row strict portable test cases unmapped: 6
...
| --- | ---: | --- | --- | --- |
| `ai` | 99% | In progress | root core SDK package | strict test inventory: 6 portable upstream cases still need named Rust tests; sample failing IDs: `packages-ai-0997`;... |

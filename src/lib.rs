...
pub use generate_text::{
    ...
    ResolveToolApprovalOptions, StaticToolCall, StaticToolError, StaticToolOutputDenied,
    ...
    ToolCallRepairFuture, ToolCallRepairOptions, ToolCallRepairOriginalError,
    ToolExecutionEndEvent, ToolExecutionStartEvent, ToolInputRefinement, ToolInputRefinementError,
    ToolInputRefinementFunction, ToolInputRefinementFuture, TypedToolCall, TypedToolError,
